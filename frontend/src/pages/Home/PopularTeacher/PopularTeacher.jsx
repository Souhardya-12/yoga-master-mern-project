    ...
    <div className='md:w-[80%] mx-auto my-36'>
        <div>
            ...
            <div className='w-[40%] text-center mx-auto my-4'>
                <p className='text-gray-500'>Explore our Popular Instructors. Here are some popular Instructors based on How many students enrolled</p>
            </div>
        </div>
        {
            instructors ? <>
                        ...
                        <div key={i} className='flex dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 md:px-8 rounded-md'>
                            <div className='flex-col flex gap-6 md:gap-8'>
                                ...
                                <div className='flex flex-col text-center'>
                                    ...
                                    <p className='text-gray-500 whitespace-nowrap'>Total Students: {instructor?.totalEnrolled}</p>
                                </div>
                            </div>
                        </div>
                    ))
