  ...
  return (
    <div>
        <div className='my-9'>
            ...
            <div>
                <p className='text-[12px] text-center my-2'>Here you can see all the classes you have added but are yet to be approved by admin</p>
            </div>
        </div>
        <div>
            {
                classes.length === 0 ? <div className='text-center text-2xl font-bold mt-10'>You have not added any class</div> : <div>
                    {
                        // Filter classes to show only the ones with 'pending' status
                        classes.filter(cls => cls.status === "pending").map((cls, index) => (
